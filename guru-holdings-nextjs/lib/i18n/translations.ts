export const translations = {
  en: {
    ...
    subscribe: {
      ...
      messages: {
        ...
        storageUnavailable: 'We could not access your browser storage. Please enable local storage to subscribe.'
      },
  ...
  zh: {
    common: {
      brand: '大师持仓追踪',
      locale: 'zh-CN',
      navigation: { home: '首页', subscribe: '订阅' },
      footer: {
    ...
    messages: {
      ...
      noData: '未找到相关数据',
      backToHome: '返回首页',
      errors: { data_not_found: '未找到对应的大师数据。', unknown_error: '加载数据时发生未知错误。' }
    },
    home: {
    ...
    subscribe: {
      ...
      button: '订阅',
      buttonLoading: '订阅中…',
      messages: { required: '请输入邮箱地址。', invalid: '请输入有效的邮箱地址。', exists: '该邮箱已经订阅过了。', success: '订阅成功！每次季度更新后我们都会通知您。', failure: '订阅失败，请稍后重试。', storageUnavailable: '无法访问您的浏览器存储，请启用本地存储后再试。' },
